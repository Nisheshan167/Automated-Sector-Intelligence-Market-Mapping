...
- **Volatility (risk / stability):** Annualized volatility summarises how widely daily prices have swung over the last 5 years. A lower value typically implies a **steadier path** and a smaller likelihood of large short-term drawdowns which is useful when the goal is preserving capital.
...
- **Risk–return trade-off:** A atock with **low volatility but acceptable total return** is generally better aligned to capital preservation than a higher-return peer that achieved it with much larger swings.
"""
)
